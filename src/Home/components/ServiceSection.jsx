...
const ServiceSection = () => {
    const services = [
        ...
        { id: 6, name: "Website Maintenance", description: "Ensure your website remains secure, reliable, and optimized with our comprehensive website maintenance service. We handle everything from software updates and security monitoring to performance optimization and content updates, allowing you to focus on your business while we keep your website running smoothly." },
    ]
    return (
